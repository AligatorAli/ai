...
public class LibDemo {
	...
	public static void main(String[] args) {
 	 ...
 	 System.out.println("Использование класса TokenizerME на русском");
				...
				String paragraph1="Фраза на русском. В 2024 году была Олимпиада.Диапозон положительных оценок составляет 3-5.";
	...
	System.outprintln("Токенизация при помощи класса DocumentPreprocessor (Stanford)");
	Reader reader= new StringReader(paragraph);
	Document Preprocessor documentPreprocessor.iterator();
	while (it.hasNext()) {
